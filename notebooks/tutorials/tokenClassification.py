...
inputs.tokens()
# Notice that we have 12 tokens but only 9 inputs
# %%
inputs.word_ids()
# %%
# Special tokens like [CLS] and [SEP] get labels of -100
# Each token gets the same label as the word it came from
